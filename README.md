...
````html
<script src="https://cdn.jsdelivr.net/npm/github-repo-cards@1.0.7/app.js" defer></script>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/github-repo-cards@1.0.7/style.css">
````
