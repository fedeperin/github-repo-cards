...
````html
<script src="https://cdn.jsdelivr.net/npm/github-repo-cards@1.0.0/app.js"></script>
<script src="https://cdn.jsdelivr.net/npm/github-repo-cards@1.0.0/style.css"></script>
````
